...
## Summary Statistics  
Exploratory data analysis consist
...
bayes_tab <- round(data.frame(glm_probs, means, medians, modes, sds, phpds), digits = 3)
...
kbl(bayes_tab,
    ...
    col.names = c("GLMM Est", "Bayes Mean", "Bayes Median", "Bayes Mode", "Bayes SD", "Bayes HPD Lower", "Bayes HPD Upper")) %>%
  kable_styling(latex_options = "hold_position") %>%
