...
???
This plot shows the increased probability of developing cataracts for each of the fixed effects in our final model. Differences between both sex and treatment group are clearly visible, and notably the differences betweeen treatment group across gender. 
...
??? 
This plot visualizes the estimated random effect, transformed into a probability, for each family in the dataset, along with confidence intervals. The vertical lines plot the GLMM estimated variance and the MCMC mode for sigma^2. 
