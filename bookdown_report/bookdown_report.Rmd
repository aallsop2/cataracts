...
knitr::opts_chunk$set(fig.width=5, fig.pos = 'H',
...
```{r RR, fig.show='hold', fig.cap='Relative risk of cataract development by all predictor combinations', fig.align='center'}
...
rrplot1 <- ggplot(rrs1, aes(x = ratio, y = Contrast, xmin = Lower, xmax = Upper)) +
  ...
  labs(x = "Relative Risk",
       title = "Within Sex, Across Treatment Group")
