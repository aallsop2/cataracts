...
```
 ...
 Results from Model \@ref(eq:glmm) and Model \@ref(eq:bayes) were congruent, as shown in Table \@ref(tab:est_tab). The 95% highest posterior density (HPD) credible intervals from Model \@ref(eq:bayes) offered the advantage of concluding 95% confidence that estimates for each parameter lay within those bounds.  
